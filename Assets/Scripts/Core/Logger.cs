...
public static class LoggerConfig
{
    ...
    public static readonly Logger.LogLevel LipsyncLogFlag = Settings.LipSync;
    public static readonly Logger.LogLevel CharacterResponseFlag = _settings.Character;
    public static readonly Logger.LogLevel ActionFlag = _settings.Actions;
    public static readonly Logger.LogLevel UIFlag = _settings.UI;
    public static readonly Logger.LogLevel GRPCFlag = _settings.GRPC;
    public static readonly Logger.LogLevel EditorFlag = _settings.Editor;
